...
else
{
    switch ($varGet["action"]) 
	{
		...
		case "validate":
			 ...
			 validatarExistencia($base,$idPrograma);
...
function validatarExistencia($base,$idPrograma)
{
	$cadenaConsulta = "SELECT COUNT(*) as cantidad FROM encuestas WHERE id='".$idPrograma;
	...
	{
		$respuesta = new Respuesta("ERROR","REPETIDO");
	}
